      ...
      {isMobile ? (
        <div style={{ marginBottom: 4 }}>
          <div style={{ fontSize: 12, color: T.inkFaint, fontWeight: 600, marginBottom: 8, textAlign: "center" }}>
            {jobRequests.length} request{jobRequests.length !== 1 ? "s" : ""}
          </div>
                ...
                >
                  ...
                  >
                    <div style={{ flex: 1, minWidth: 0, paddingRight: 8 }}>
                      ...
                      <div style={{ fontSize: 12, color: T.inkFaint, marginTop: 4 }}>{r.location || "—"}</div>
                    </div>
                    <div style={{ fontSize: 11, color: T.inkFaint, flexShrink: 0 }}>
                      {idx + 1}/{jobRequests.length}
                    </div>
                  </div>
                  ...
                  <div style={{ padding: "14px 18px", display: "flex", flexDirection: "column", gap: 8, borderBottom: `1px solid ${T.border}` }}>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                      <span style={{ fontSize: 11, fontWeight: 700, color: T.inkFaint, textTransform: "uppercase", letterSpacing: "0.05em" }}>Vacancies</span>
                      <span style={{ fontSize: 13, color: T.ink }}>{r.vacancies || "—"}</span>
                    </div>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                      <span style={{ fontSize: 11, fontWeight: 700, color: T.inkFaint, textTransform: "uppercase", letterSpacing: "0.05em" }}>Experience</span>
                      <span style={{ fontSize: 13, color: T.ink }}>{r.exp || "—"}</span>
                    </div>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                      <span style={{ fontSize: 11, fontWeight: 700, color: T.inkFaint, textTransform: "uppercase", letterSpacing: "0.05em" }}>Qualification</span>
                      <span style={{ fontSize: 13, color: T.ink }}>{r.qual || "—"}</span>
                    </div>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                      <span style={{ fontSize: 11, fontWeight: 700, color: T.inkFaint, textTransform: "uppercase", letterSpacing: "0.05em" }}>Type</span>
                      <span style={{ fontSize: 13, color: T.ink }}>{r.type || "—"}</span>
                    </div>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                      <span style={{ fontSize: 11, fontWeight: 700, color: T.inkFaint, textTransform: "uppercase", letterSpacing: "0.05em" }}>Salary</span>
                      <span style={{ fontSize: 13, color: T.ink, fontWeight: 600 }}>{r.salary || "—"}</span>
                    </div>
                  </div>
